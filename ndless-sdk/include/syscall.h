...
template <int nr> int syscall_addr()
{
	return 
		...
		syscall_addrs[17][nr];
                ...
                syscall_addrs[21][nr];
#elif defined(NDLESS_420)
                ut_os_version_index == 22 ? syscall_addrs[22][nr] :
                syscall_addrs[23][nr];
#elif defined(NDLESS_430)
                ut_os_version_index == 24 ? syscall_addrs[24][nr] :
                syscall_addrs[25][nr];
                ...
                syscall_addrs[29][nr];
#elif defined(NDLESS_453) && defined(NDLESS_520)
		ut_os_version_index == 32 ? syscall_addrs[32][nr] :
		ut_os_version_index == 33 ? syscall_addrs[33][nr] :
		ut_os_version_index == 34 ? syscall_addrs[34][nr] :
		ut_os_version_index == 35 ? syscall_addrs[35][nr] :
		syscall_addrs[36][nr];
#else
